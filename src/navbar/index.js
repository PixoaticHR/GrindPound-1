    ...
    <nav className="bg-white shadow fixed top-0 left-0 w-full z-10">
      <div className="mx-auto space-x-4">
        <div className="grid lg:grid-cols-12 md:grid-cols-12 sm:grid-cols-12 bg-black">
          <div className="text-xs lg:col-span-7 md:col-span-8 ml-2 sm:col-span-12 p-4 font-articulat text-white font-normal cursor-pointer text-xs">
          ...
          <div className="lg:col-span-5 md:col-span-4 sm:col-span-12 p-2 font-articulat text-white font-light text-right">
              <div className=" p-1 m-2 cursor-pointer font-normal inline-block inline-block p-1 rounded-t-lg hover:text-[#009898] hover:border-[#009898] dark:hover:text-[#009898] text-xs ml-12" onClick={() => linkPage("/help")}>Help</div>
